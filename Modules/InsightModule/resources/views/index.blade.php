            ...
            <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                <div class="card">
                    ...
                    <div class="card-body service-details">
                        ...
                        <p>Explore the benefits of cloud computing for businesses, from scalability and cost-efficiency to enhanced security and collaboration.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                <div class="card">
                    ...
                    <div class="card-body service-details">
                        ...
                        <p>Learn how IoT solutions are transforming industries by connecting devices, collecting data, and improving operational efficiency.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
