    ...
    <div class="invoice-print p-5">
        ...
        <div class="row">
            <div class="col-sm-6 mb-4">
                ...
                <div> <span class="font-weight-bold mb-2">Billed  To:</span> {{ $quotation->client->client_name }}</div>
                <div> <span class="font-weight-bold mb-2">Address:</span> {{ $quotation->client->address }}</div>
                <div><span class="font-weight-bold mb-2">Contact:</span> {{ $quotation->client->contact }}</div>
                <div><span class="font-weight-bold mb-2">Date:</span> {{ $quotation->created_at }}</div>
                @endforeach
            </div>
            <div class="col-sm-6 mb-4">
               @foreach($quotations as $quotation)
                <div> <span class="font-weight-bold mb-2">Company:</span> {{ $quotation->client->company }}</div>
                <div> <span class="font-weight-bold mb-2">Customer Number:</span> {{ $quotation->client->customer_number }}</div>
                <div><span class="font-weight-bold mb-2">Email:</span> {{ $quotation->client->email }}</div>
