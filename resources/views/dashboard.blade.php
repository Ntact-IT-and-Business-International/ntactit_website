...
<!-- Mirrored from html.phoenixcoded.net/empire/bootstrap/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 09:33:23 GMT -->
<head>
                            ...
                            <div class="demo-navbar-user nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                    <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                        <img src="{{ asset('admin/assets/img/avatars/1.png')}}" alt class="d-block ui-w-30 rounded-circle">
