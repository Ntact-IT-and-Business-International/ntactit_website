    ...
    <div class="row">
        ...
        <div class="card bg-primary mb-4">
            <div class="card-body text-center">
                ...
                <h4 class="mt-2 font-weight-bold text-larger" style="font-size: 25px;;"> Asiimire Desire</h4>
            </div>
        </div>
            ...
            <div class="card text-center mb-3">
                ...
                @if (session()->has('msg'))
                    ...
                    <div class="row align-employee_records-center m-l-0">
                        ...
                        <button  class="btn btn-sm btn-outline-info mb-2" onclick="Livewire.dispatch('openModal', { component: 'admin.account-setting.add-user' })"><i class="feather icon-plus"></i> Add Permission (s)</button>
                        </div>
                    </div>
                        ...
                        <table id="report-table" class="table table- table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/accountsetting/assign-or-remove-permission/{{$user->employee_id}}" class="btn btn-outline-warning"><i class="feather icon-plus"></i>&nbsp;Remove Permissions </a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
