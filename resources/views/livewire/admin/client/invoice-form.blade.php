            ...
            <form wire:submit.prevent="addInvoice">
                ...
                <div class="col-sm-12 text-center">
                    <button type="submit" class="btn btn-primary">
                        <span wire:loading wire:target="addInvoice"><i class="fa fa-spinner fa-spin"></i> Wait...it is submitting Now</span>
                        <span wire:loading.remove wire:target="addInvoice">Submit</span>
                    </button>
                </div>
            </form>
        </div>
