                                ...
                                @foreach ($clients as $i => $client)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#!" class="btn btn-warning btn-sm mb-2"><i class="feather icon-trash-2"></i>&nbsp;Quotation</a><br>
                                            <a href="#!" class="btn btn-success btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Invoice</a>
